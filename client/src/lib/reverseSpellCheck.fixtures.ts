...
export const reverseRuleFixtures: ReverseRuleFixture[] = [
  ...
  {
    name: "spacing rules",
    input: "할 수 있는 만큼 보고 싶다. 띄어쓰기를 확인했다.",
    expectedWrongWords: ["할수", "만 큼", "보고싶다", "띠어쓰기"],
    expectedOriginals: ["할 수", "만큼", "보고 싶다", "띄어쓰기"],
    expectedTypes: ["띄어쓰기", "띄어쓰기", "띄어쓰기", "맞춤법"],
  },
  {
  ...
  {
    name: "article 51 adverbs written with 이",
    input: "깨끗이 정리하고 따뜻이 맞았다. 가까이 보면 많이 달라진다.",
    expectedWrongWords: ["깨끗히", "따뜻히", "가까히", "많히"],
    expectedOriginals: ["깨끗이", "따뜻이", "가까이", "많이"],
    expectedTypes: ["맞춤법", "맞춤법", "맞춤법", "맞춤법"],
  },
  {
    name: "article 51 adverbs written with 히",
    input: "극히 정확히 말했고 특히 솔직히 조용히 기다렸다.",
    expectedWrongWords: ["극이", "정확이", "특이", "솔직이", "조용이"],
    expectedOriginals: ["극히", "정확히", "특히", "솔직히", "조용히"],
    expectedTypes: ["맞춤법", "맞춤법", "맞춤법", "맞춤법", "맞춤법"],
  },
  {
    name: "article 51 short adverb 적이 stays contextual",
    input: "그런 적이 드물었다.",
    expectedWrongText: "그런 적이 드물었다.",
    expectedWrongWords: [],
    expectedOriginals: [],
  },
  {
    name: "article 51 short adverb 적이 can be enabled",
    input: "적이 드문 일이다.",
    includeContextual: true,
    expectedWrongWords: ["적히"],
    expectedOriginals: ["적이"],
    expectedTypes: ["맞춤법"],
  },
  {
    name: "article 51 adverbs do not match inside longer words",
    input: "신속히 처리하고 외향적이고 침착하다.",
    expectedWrongText: "신속히 처리하고 외향적이고 침착하다.",
    expectedWrongWords: [],
    expectedOriginals: [],
  },
  {
