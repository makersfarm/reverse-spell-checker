...
const REVERSE_RULES: ReverseRule[] = [
  ...
  rule("되어", "돼", "맞춤법", "'되어'를 줄이면 '돼'가 맞아요."),
  ...
  rule("바라", "바래", "맞춤법", "소원을 나타낼 땐 '바라다'가 맞아요. '바래다'는 색이 바래는 것!"),
  rule("건드리다", "건들이다", "표준어", "'건드리다'가 맞아요. '건들이다'로 자주 헷갈려요."),
  rule("움츠리다", "움추리다", "표준어", "'움츠리다'가 맞아요. '움추리다'로 자주 헷갈려요."),
  rule("낫다", "낳다", "맞춤법", "'낫다'는 회복하다, '낳다'는 출산하다. 전혀 다른 말이에요!"),
  rule("낳다", "낫다", "맞춤법", "'낳다'는 출산하다, '낫다'는 회복하다. 전혀 다른 말이에요!"),
  rule("가르치", "가리키", "맞춤법", "'가르치다'는 교육, '가리키다'는 방향 지시예요."),
  rule("가리키", "가르치", "맞춤법", "'가리키다'는 방향 지시, '가르치다'는 교육이에요."),
  rule("잊어버리", "잃어버리", "맞춤법", "'잊다'는 기억을 못 하는 것, '잃다'는 물건을 잃는 것이에요."),
  rule("잃어버리", "잊어버리", "맞춤법", "'잃다'는 물건을 잃는 것, '잊다'는 기억을 못 하는 것이에요."),
  rule("나뭇잎", "나무잎", "맞춤법", "합성어에서 뒷말이 된소리가 나면 사이시옷을 써요."),
  rule("나무잎", "나뭇잎", "맞춤법", "합성어에서 뒷말이 된소리가 나면 사이시옷을 써요."),
  rule("햇살", "해살", "맞춤법", "'햇살'은 '해'+'살'의 합성어로 사이시옷이 들어가요."),
  rule("짜장면", "자장면", "표준어", "'짜장면'과 '자장면' 모두 표준어예요! (2011년 복수 표준어 인정)"),
  rule("자장면", "짜장면", "표준어", "'자장면'과 '짜장면' 모두 표준어예요! (2011년 복수 표준어 인정)"),
  ...
  rule("한테", "한 테", "띄어쓰기", "조사 '한테'는 앞말에 붙여 써야 해요."),
  rule("에게", "에 게", "띄어쓰기", "조사 '에게'는 앞말에 붙여 써야 해요."),
  rule("처럼", "처 럼", "띄어쓰기", "조사 '처럼'은 앞말에 붙여 써야 해요."),
  rule("가 있", "이 있", "맞춤법", "받침 없는 명사 뒤엔 '가', 받침 있으면 '이'예요."),
  rule("이 있", "가 있", "맞춤법", "받침 없는 명사 뒤엔 '가', 받침 있으면 '이'예요."),
  rule("을 ", "를 ", "맞춤법", "받침 있는 명사 뒤엔 '을', 없으면 '를'이에요."),
  rule("를 ", "을 ", "맞춤법", "받침 없는 명사 뒤엔 '를', 있으면 '을'이에요."),
  rule("은 ", "는 ", "맞춤법", "받침 있는 명사 뒤엔 '은', 없으면 '는'이에요."),
  rule("는 ", "은 ", "맞춤법", "받침 없는 명사 뒤엔 '는', 있으면 '은'이에요."),
  rule("않", "안", "맞춤법", "'않다'는 '아니하다'의 줄임. '안 하다'와 달라요!"),
  rule("안 하", "않하", "맞춤법", "'안 하다'와 '않다'는 쓰임이 달라요."),
  rule("어요", "아요", "맞춤법", "양성모음(ㅏ,ㅗ) 뒤엔 '-아요', 나머지엔 '-어요'예요."),
  rule("어서", "아서", "맞춤법", "양성모음 뒤엔 '-아서', 나머지엔 '-어서'예요."),
  rule("아서", "어서", "맞춤법", "양성모음 뒤엔 '-아서', 나머지엔 '-어서'예요."),
...
const FALLBACK_RULES: ReverseRule[] = [
  ...
  rule(/이 /g, "가 ", "맞춤법", "일반적인 맞춤법 오류가 적용됐어요."),
  rule(/가 /g, "이 ", "맞춤법", "일반적인 맞춤법 오류가 적용됐어요."),
